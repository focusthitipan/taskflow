...
| **Member** 👤 | สร้าง/แก้ไข Task ที่ตัวเองได้รับมอบหมาย หรือที่ตัวเองสร้าง | สมาชิกทีมทั่วไป |
...
|---|---|---|---|
| สร้าง Task | ✅ | ✅ | ❌ |
| แก้ไข Task (PUT) | ✅ | ✅ (เฉพาะที่ตัวเองถูก assign หรือเป็นคนสร้าง) | ❌ |
| เปลี่ยน Status (PATCH) | ✅ | ✅ (เฉพาะที่ตัวเองถูก assign หรือเป็นคนสร้าง) | ❌ |
| ลบ Task | ✅ | ❌ | ❌ |
| เพิ่ม Comment | ✅ | ✅ | ❌ |
...
| **Task Scoping** | Member แก้ไข Task ได้เฉพาะที่ตัวเองถูก assign หรือเป็นคนสร้าง — ตรวจสอบผ่าน `canEditTask()` |
...
| `authorizeWrite()` | `src/app/api/tasks/[id]/route.ts` | Member ต้องถูก assign หรือเป็นคนสร้างถึงแก้ไข Task ได้ |
| `canEditTask()` | `src/lib/can-edit.ts` | ตรวจสอบ UI-level: Member แก้ไข/Drag ได้เฉพาะ Task ที่ถูก assign หรือเป็นคนสร้าง |
